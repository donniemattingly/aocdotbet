...
export const AtLeastStarsThem = ({opponentUid, myUid, groupId}) => {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                <p>
                    --- Number of Stars (them) ---
                </p>
                <p>
                    Propose a number of stars. If they get at least that number of stars, they win!
                </p>
                <span>

                </span>
                <span>
                        I bet you'll get no more than{' '}
